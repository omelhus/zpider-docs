...
| - | - | - |
| 2020-05-04 | v12.0.417 | Fixed missing templates for `updatenewuser` and fixed issue with NordicCool when using ZpiderHeader. NordicCool and ResponsiveCool are now defined using theme.json. Minor fixes for plugins unit support and Klara Checkout. |
...
A huge thanks to [Markus at Tigerton AB](mailto:markus@tigerton.se) for helping out with the design. He can help you out if you need a design as well!