...
- If the disk ran out of space fusion would not start because of corrupted message files
...
A huge thanks to Markus at Tigerton AB for helping out with the design. He can help you out if you need a design as well!